...
function Get-PhpIniBlock {
    ...
    $lines = @(
        ...
        '; fix_pathinfo steht bewusst auf 1. Die verbreitete Empfehlung 0 stammt aus',
        '; nginx-Aufbauten, wo der Webserver beliebige Dateien an PHP durchreicht und',
        '; ein hochgeladenes Bild ueber /bild.gif/x.php ausgefuehrt werden konnte.',
        '; Caddys php_fastcgi reicht nur .php-Dateien durch, der Angriff greift also',
        '; nicht - nachgemessen mit php-cgi 8.4 und Caddy 2.10: /upload.txt/x.php und',
        '; /bild.gif/x.php landen beide bei index.php, die hochgeladene Datei wird nie',
        '; ausgefuehrt. Mit 0 waere dagegen PATH_INFO kaputt ("No input file',
        '; specified"), was Anwendungen mit Routen wie /index.php/seite/unterseite',
        '; unbrauchbar macht.',
        'cgi.fix_pathinfo = 1',
